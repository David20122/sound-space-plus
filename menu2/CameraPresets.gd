...
var presets = [
	...
	{ name = "Spin", cam = 1, ui = 0, grid = 0, spin = true, faraway = false },
	{ name = "Spin (no parallax)", cam = 0, ui = 0, grid = 0, spin = true, faraway = false },
	{ name = "Spin (faraway hud)", cam = 1, ui = 0, grid = 0, spin = true, faraway = true },
	{ name = "Half-lock (faraway hud)", cam = 6.5, ui = 3.25, grid = 0, spin = false, faraway = true },
	...
	{ name = "Reverse-lock (faraway hud)", cam = -6.5, ui = -3.25, grid = 0, spin = true, faraway = true },
]
